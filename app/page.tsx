  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 1100px 700px at 50% 15%, rgba(77,184,232,0.08), transparent 60%), radial-gradient(ellipse 800px 600px at 20% 70%, rgba(77,184,232,0.05), transparent 55%), radial-gradient(ellipse 800px 500px at 85% 45%, rgba(77,184,232,0.04), transparent 55%), #07090f",
        }}
      />
